...
export default function IngredientsCoffee({ onSubmit }) {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    let message = `Выбрано кофе-латте. Имя: ${values.name}, тел: ${values.phone}, комментарий: ${values.comment},`;
    onSubmit(message);
  ...
  return (
    <div className='in__back'>
      <div className='in__container'>
        <h4 className='in__title'>Кофе-латте с&nbsp;шоколадом</h4>
        <div className='in__box'>
          <img src={coffee} alt='coffee' className='in__photo' />
        ...
        <ul className='in__list'>
          ...
          <li className='in__element'>
            <p className='in__ingredients'>Кофе</p>
