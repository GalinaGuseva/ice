  ...
  return (
    <div className='read'>
      <div className='read__container'>
        ...
        <p className='read__text'>
          - подготовка исходного сырья; приготовление смеси для мороженого,
          путем смешивания сырьевых компонентов, согласно рецептуре;
        </p>
        <p className='read__text'>
          {' '}
          - фильтрование и пастеризация смеси для очистки от механических
          примесей и патогенных микроорганизмов;
        </p>
        <p className='read__text'>
          {' '}
