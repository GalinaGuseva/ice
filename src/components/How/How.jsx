          ...
          <div className='how__right-block'>
            <div className='how__textblock'>
              <p className='how__text'>
                Мороженое — это еда, с которой вы станете не только чуточку
                счастливее, но и здоровее. Здоровье – главная ценность для нас,
                и мы руководствуемся ею при создании наших десертов ручной
                работы.
              </p>
              <p className='how__text'>
                Мы используем традиционные рецепты и 100% натуральные
                ингредиенты. Наши продукты настолько натуральны, что их можно
                давать детям с трехлетнего возраста. Любителей сладкого ждет 55
                видов мороженого, 15 видов кофе и 23 молочных коктейля.
              </p>
              <p className='how__text'>
                Этого достаточно, чтобы выбрать мороженое и кофе под любое
                настроение!
              </p>
            </div>
            <Link to='/read'>
