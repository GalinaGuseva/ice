                    ...
                    <ul className="prod__items">
                        <li className="prod__item">
                            <div className="prod__rectangle prod__rectangle_ice">
                                ...
                                <p className="prod__item-text">Мягкое мороженое с нежным вкусом. Изготовлено из молока, сливок, сахара и натурального стабилизатора</p>
                        ...
                        <li className="prod__item">
                            <div className="prod__rectangle prod__rectangle_coffee">
                                ...
                                <p className="prod__item-text">Ароматный бодрящий напиток, созданный из 100% натуральных ингредиентов без использования консервантов и усилителей вкуса.</p>
                                    <div className="prod__item-arrow"></div>
                            </div>
                        </li>
                        <li className="prod__item">
                            <div className="prod__rectangle prod__rectangle_shake">
                                ...
                                <p className="prod__item-text">Сладкие напитки на основе молока и мороженого, дополненные сиропами, фруктами, ягодами и другими сладостями на выбор</p>
                                <div className="prod__item-arrow"></div>
                            </div>
                        </li>
                    </ul>
