...
<section className="contacts" id="contacts">
            <ul className="contacts__places">
                <li className="contacts__item contacts__item_left">
                    <div className="contacts__container">
                        ...
                        <p className="contacts__address">Краснопресненская наб., 132, Москва</p>
                        ...
                        <p className="contacts__hours contacts__hours_bottom">08:00 - 16:00</p>
                        <p className="contacts__phone">+7(495)383 76 62 icecream@gmail.com</p>
                    </div>
                </li>
                <li className="contacts__item contacts__item_middle">
                    <div className="contacts__container">
                        ...
                        <p className="contacts__address">ул. Дзержинского, дом 49, Тамбов</p>
                        <p className="contacts__days">Пон - Пятница</p>
                        <p className="contacts__hours">08:00 - 22:00</p>
                        <p className="contacts__days">Суббота - Воскр.</p>
                        <p className="contacts__hours contacts__hours_bottom">08:00 - 16:00</p>
                ...
                <li className="contacts__item contacts__item_right">
                    <div className="contacts__container">
                        ...
                        <p className="contacts__address">парк им. Солнца, центр. аллея, Калуга</p>
                        <p className="contacts__days">Пон - Пятница</p>
                        <p className="contacts__hours">08:00 - 22:00</p>
                        <p className="contacts__days">Суббота - Воскр.</p>
                        <p className="contacts__hours contacts__hours_bottom">08:00 - 16:00</p>
            ...
            <div className="contacts__buttons">
                <button type="button" className="contacts__left-btn link_button">Местоположение<span className="contacts__button-icon">
                       </span></button>
                <button type="button" className="contacts__right-btn button">Франшиза </button>
            </div>
        </section>
    );
}