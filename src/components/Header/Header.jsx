...
export default function Header() {
  return (
    <header className="header">
            ...
            <button type="button" className="header__menu_mobile"></button>
            <button type="button" className="header__button link_button">
            ...
            <div className="header__title-and-buttons">
                ...
                <div className="header__buttons">
                    <button type="button" className="header__btn_left button">Выбрать</button>
                    <button type="button" className="header__btn_right">Как&nbsp;это&nbsp;делают?</button>
                </div>
            </div>
            <img src={creams} alt="шесть мороженок" className="header__img"/>
            <div className="header__box">
                <div className="header__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                    tempor incididunt ut labore et</div>
                <a href="#contacts" className="header__arrow">-</a>
            </div>
